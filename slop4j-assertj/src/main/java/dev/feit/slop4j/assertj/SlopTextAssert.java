...
public final class SlopTextAssert extends AbstractAssert<SlopTextAssert, String> {
	...
	/**
	 * Requires the concreteness score to be higher than the exclusive threshold in
	 * the {@code
	 * 0.0..1.0} range.
	 */
	...
	/**
	 * Requires the actionability score to be higher than the exclusive threshold in
	 * the {@code
	 * 0.0..1.0} range.
	 */
	...
	/**
	 * Requires the evidence score to be higher than the exclusive threshold in the
	 * {@code 0.0..1.0} range.
	 */
	...
	/**
	 * Requires the repetition score to be lower than the exclusive threshold in the
	 * {@code
	 * 0.0..1.0} range.
	 */
	...
	/**
	 * Requires the overconfidence score to be lower than the exclusive threshold in
	 * the {@code
	 * 0.0..1.0} range.
	 */
	...
	/**
	 * Requires the verdict to be neither {@code LINKEDIN_READY} nor
	 * {@code BOARD_APPROVED_SLOP}.
	 */
	...
	/**
	 * Requires the verdict to be {@code LINKEDIN_READY} or
	 * {@code BOARD_APPROVED_SLOP}.
	 */
	...
	/**
	 * Returns the lazily computed report, reusing the same instance for subsequent
	 * calls.
	 */
