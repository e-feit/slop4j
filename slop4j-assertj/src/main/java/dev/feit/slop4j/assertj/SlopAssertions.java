...
public final class SlopAssertions {
    ...
    /**
     * Creates assertions for text analyzed with the default core analyzer configuration.
     *
     * @param actual text to analyze; null is passed to the core analyzer unchanged
     ...
     *
     * @param actual text to analyze; null is passed to the core analyzer unchanged
     * @param first first language to enable
     * @param rest additional languages to enable
     * @return assertions for the analyzed text
     */
    public static SlopTextAssert assertThatSlop(
            @Nullable String actual, Language first, Language... rest) {
     ...
     *
     * @param actual text to analyze; null is passed to the core analyzer unchanged
     * @param languages languages to enable
     * @return assertions for the analyzed text
     */
    public static SlopTextAssert assertThatSlop(
            @Nullable String actual, Collection<Language> languages) {
     ...
     *
     * @param actual text to analyze; null is passed to the analyzer unchanged
     * @param analyzer analyzer used to compute the report lazily
     * @return assertions for the analyzed text
     */
     ...
     *
     * @param actual report to inspect
