 ...
 *
 * <p>
 * The final {@code slopScore} is normalized to {@code 0.0..100.0}. All other
 * numeric scores are normalized to {@code 0.0..1.0}.
 */
public record SlopReport(double slopScore, double buzzwordDensity, double vaguePhraseDensity, double concretenessScore,
		double actionabilityScore, double evidenceScore, double repetitionScore, double overconfidenceScore,
		SlopVerdict verdict, List<SlopFinding> findings) {
