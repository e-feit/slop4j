...
public record SlopContext(String originalText, String normalizedText, List<String> tokens, List<String> sentences,
	...
	public static SlopContext create(@Nullable String text, DictionarySet dictionaries) {
		...
		return new SlopContext(original, normalized, TextTokenizer.tokens(original), TextTokenizer.sentences(original),
				dictionaries);
	}
