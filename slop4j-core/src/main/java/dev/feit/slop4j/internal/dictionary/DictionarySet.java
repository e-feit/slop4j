...
public record DictionarySet(Set<String> buzzwords, Set<String> abstractNouns, List<String> vaguePhrases,
		Set<String> weaselWords, Set<String> activeVerbs, Set<String> concreteTerms, Set<String> claimMarkers) {

	public static DictionarySet empty() {
		return new DictionarySet(Set.of(), Set.of(), List.of(), Set.of(), Set.of(), Set.of(), Set.of());
	}
