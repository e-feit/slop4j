...
public final class AssertJQualityGateExample {
	...
	public static void main(String[] args) {
		assertThatSlop(technicalDocumentation(), Language.ENGLISH).hasSlopScoreBelow(40.0)
				.hasActionabilityScoreAbove(0.3).containsConcreteDetails().doesNotSoundLikeLinkedInPost();

		assertThatSlop(strategyDeckNarrative(), Language.ENGLISH).isBoardDeckReady().containsNoImplementationDetails()
